...
export default function App() {
  ...
  const handleGeneratePrintOutput = (lang: 'id' | 'en', from: string, to: string, reportType: 'standard' | 'donor' | 'ceo' = 'standard') => {
    ...
    const projectSubActivities = subActivities.filter((sub) => projectActivities.some((act) => isIdMatch(sub.parentActivityId, act.id)));
    ...
    const rangedActivities = projectActivities.filter((act) => {
      ...
      const hasSubInRange = rangedSubActivities.some((sub) => isIdMatch(sub.parentActivityId, act.id));
    ...
    const L = isID ? {
      ...
      sec_hambatan: 'CATATAN PERKEMBANGAN & HAMBATAN PELAKSANAAN',
      ...
      actStatus: 'Status', actProg: 'Progress', actNotes: 'Catatan Perkembangan & Hambatan',
      budAppr: 'Anggaran Disetujui', budAct: 'Realisasi', budLeft: 'Sisa',
      date: 'Tanggal', updBy: 'Diperbarui Oleh', amount: 'Jumlah', note: 'Keterangan',
      noHambatan: 'Tidak ada catatan perkembangan atau hambatan yang dicatat.',
      ...
      pageOf: 'Halaman',
      hambatanDesc: 'Dihimpun dari catatan perkembangan & tantangan yang dicatat pada setiap aktivitas & sub-aktivitas pelaksanaan.',
      ...
      sec_hambatan: 'PROGRESS NOTES & CHALLENGES',
      ...
      actStatus: 'Status', actProg: 'Progress', actNotes: 'Progress Notes & Challenges',
      budAppr: 'Approved Budget', budAct: 'Realization', budLeft: 'Remaining',
      date: 'Date', updBy: 'Updated By', amount: 'Amount', note: 'Note',
      noHambatan: 'No progress notes or challenges have been recorded.',
      ...
      pageOf: 'Page',
      hambatanDesc: 'Compiled from progress & challenge notes recorded on each implementation activity & sub-activity.',
          ...
          <div style="border-left: 3px solid #3b82f6; padding-left: 14px; margin-top: 4px; margin-bottom: 4px;">
            ...
            <div style="display: flex; flex-direction: column; gap: 6px;">
              ${subActsForThisAct.map(sub => {
                ...
                const subNotesHtml = sub.notes && sub.notes.length > 0
                  ? `
                    <div style="margin-top: 6px; padding: 5px 8px; background: #f8fafc; border-radius: 5px; border: 1px solid #f1f5f9; display: flex; flex-direction: column; gap: 3px;">
